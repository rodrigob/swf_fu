...
This version of +swf_fu+ will only work with rails 3.1. 
No real tests have been done other than "getting it to work on my application".
...
+swf_fu+ from
github[http://github.com/marcandre/swf_fu/archives/master] and then install following theirs instructions.
...
+swf_fu+ will add 'swfobject' to the list asssets. 
It should be included in the pages using the swf_tag. (see install instructions)
